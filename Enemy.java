...
public class Enemy extends Character{ 
     ...
     */
    public Enemy(int x, int y, int width, int height, BufferedImage image, String name, String resourceName, int level, double maxHealth){
        super(x, y, width, height, image, name, resourceName);
        this.setLevel(level);
        this.setMaxHealth(maxHealth);       //If it needs to be set.
