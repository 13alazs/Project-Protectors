...
public class AbilityTooltip extends JPanel {
    ...
    public AbilityTooltip(int x, int y, Ability ability, String resource) {
        ...
        if ("attack".equals(ability.getAbilityType())) {
            text = "<html><font style='font-size: 15px;'>" + ability.getName() + "<br></font>Deal <font color='red'>"
                    + ability.getAttackDamage() + "</font> damage to the targeted <font color='red'>enemy.</font>"
                    + "<br>Cooldown: " + ability.getCooldown() + " turns ,<br>" + resource
                    + " cost: <font color='yellow'>" + ability.getCost() + "</font>" + ",<br>target count: "
                    + ability.getTargetCount() + "<html>";
            ...
            text = "<html><font style='font-size: 15px;'>" + ability.getName()
                    ...
                    + "</font> health to the targeted <font color='green'>ally</font>." + "<br>Cooldown: "
                    + ability.getCooldown() + " turns ,<br>" + resource + " cost: <font color='yellow'>"
                    + ability.getCost() + "</font>" + ",<br>target count: " + ability.getTargetCount() + "<html>";
        } else if ("stun".equals(ability.getAbilityType())) {
            text = "<html><font style='font-size: 15px;'>" + ability.getName()
                    + "<br></font>Stuns an <font color='red'>enemy</font> for <font color='red'>" + "</font> 1 rounds."
                    + "<br>Cooldown: " + ability.getCooldown() + " turns ,<br>" + resource
                    + " cost: <font color='yellow'>" + ability.getCost() + "</font>" + ",<br>target count: "
                    + ability.getTargetCount() + "<html>";
